...
![Страница авторизации](assets/images/LogIn.png)

Страница регистрации:
![Страница регистрации](assets/images/SignUp.png)

Страница с чатами:
![Страница с чатами](assets/images/MainPage.png)

Добавить чат:
![Добавить чат](assets/images/AddChannel.png)

Управление чатом:
![Управление чатом](assets/images/Menu.png)

Переименовать чат:
![Переименовать чат](assets/images/EditChannel.png)

Отправка сообщений в чате:
![Отправка сообщений в чате](assets/images/Message.png)
...
В другом терминале запускаем backend-сервер:
