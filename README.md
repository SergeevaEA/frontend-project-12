...
![Страница авторизации](src/assets/images/LogIn.png)

Страница регистрации:
![Страница регистрации](src/assets/images/SignUp.png)

Страница с чатами:
![Страница с чатами](src/assets/images/MainPage.png)

Добавить чат:
![Добавить чат](src/assets/images/AddChannel.png)

Управление чатом:
![Управление чатом](src/assets/images/Menu.png)

Переименовать чат:
![Переименовать чат](src/assets/images/EditChannel.png)

Отправка сообщений в чате:
![Отправка сообщений в чате](src/assets/images/Message.png)
